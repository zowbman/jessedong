...
public interface BNewsMapper {
    ...
    @Insert("insert ignore into t_news(title,text,resume,isTop,addTime) values(#{title},#{text},#{resume},#{isTop},#{addTime})")
    boolean save(@Param("title") String title, @Param("text") String text, @Param("resume") String resume, @Param("isTop") int isTop, @Param("addTime") int addTime);

    @Update("update t_news set title=#{title},text=#{text},resume=#{resume},isTop=#{isTop},addTime=#{addTime} where id=#{id}")
    boolean update(@Param("id") int id, @Param("title") String title, @Param("text") String text, @Param("resume") String resume, @Param("isTop") int isTop, @Param("addTime") int addTime);
